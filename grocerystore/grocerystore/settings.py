...
SECRET_KEY = 'django-insecure-@0!oria0j$p!9)wh7m2i+47biq+bq#kw+%r5tthf*cavvqz6pi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
MEDIA_ROOT = '%s/grocerystoreapp/static/' % BASE_DIR
ALLOWED_HOSTS = []
...
AUTH_USER_MODEL = 'grocerystoreapp.User'
# Password validation
